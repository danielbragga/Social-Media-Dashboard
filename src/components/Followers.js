  ...
  return (
    <>
      <section className="relative z-10 max-w-7xl mx-auto py-10 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4 ">
        ...
        <article className="bg-slate-200 p-5 rounded-lg dark:bg-slate-800 shadow shadow-slate-50 dark:shadow-slate-700 border-t-8 border-blue-600">
          <ul className="flex items-center justify-center text-center">
            <li>
        ...
        <article className="bg-slate-200 p-5 rounded-lg dark:bg-slate-800 shadow shadow-slate-50 dark:shadow-slate-700 relative">
        ...
        <article className="bg-slate-200 p-5 dark:bg-slate-800 rounded-lg shadow shadow-slate-50 dark:shadow-slate-700 border-t-8 border-red-700">
          <ul className="flex items-center justify-center text-center">
            <li>
