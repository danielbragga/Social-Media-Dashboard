    ...
    <>
      ...
      <section className="max-w-7xl mx-auto grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
        <article className="bg-slate-200 p-5 dark:bg-slate-800 rounded shadow shadow-slate-50 dark:shadow-slate-700">
          ...
          <ul className="flex itens-center justify-between">
            <li className="font-bold text-slate-800 dark:text-white  text-3xl">
              87
            </li>
            <li className="flex items-center text-emerald-600 font-bold text-sm">
              <img src={up} alt="" className="w-3 mr-2" /> 3%
            </li>
          </ul>
        </article>
        ...
        <article className="bg-slate-200 p-5 dark:bg-slate-800 rounded shadow shadow-slate-50 dark:shadow-slate-700">
          ...
          <ul className="flex itens-center justify-between">
            ...
            <li className="flex items-center text-rose-600 font-bold text-sm">
              <img src={down} alt="" className="w-3 mr-2" /> 2%
            </li>
          </ul>
        </article>
        ...
        <article className="bg-slate-200 p-5 dark:bg-slate-800 rounded shadow shadow-slate-50 dark:shadow-slate-700">
          ...
          <ul className="flex itens-center justify-between">
            ...
            <li className="flex items-center text-emerald-600 font-bold text-sm">
              <img src={up} alt="" className="w-3 mr-2" /> 2257%
            </li>
          </ul>
        </article>
        ...
        <article className="bg-slate-200 p-5 dark:bg-slate-800 rounded shadow shadow-slate-50 dark:shadow-slate-700">
          ...
          <ul className="flex itens-center justify-between">
            ...
            <li className="flex items-center text-emerald-600 font-bold text-sm">
              <img src={up} alt="" className="w-3 mr-2" /> 1375%
            </li>
          </ul>
        </article>
        ...
        <article className="bg-slate-200 p-5 dark:bg-slate-800 rounded shadow shadow-slate-50 dark:shadow-slate-700">
          ...
          <ul className="flex itens-center justify-between">
            ...
            <li className="flex items-center text-emerald-600 font-bold text-sm">
              <img src={up} alt="" className="w-3 mr-2" /> 303%
            </li>
          </ul>
        </article>
        ...
        <article className="bg-slate-200 p-5 dark:bg-slate-800 rounded shadow shadow-slate-50 dark:shadow-slate-700">
          ...
          <ul className="flex itens-center justify-between">
            ...
            <li className="flex items-center text-emerald-600 font-bold text-sm">
              <img src={up} alt="" className="w-3 mr-2" /> 553%
            </li>
          </ul>
        </article>
        ...
        <article className="bg-slate-200 p-5 dark:bg-slate-800 rounded shadow shadow-slate-50 dark:shadow-slate-700">
          ...
          <ul className="flex itens-center justify-between">
            ...
            <li className="flex items-center text-rose-600 font-bold text-sm">
              <img src={down} alt="" className="w-3 mr-2" /> 19%
            </li>
          </ul>
        </article>
        ...
        <article className="bg-slate-200 p-5 dark:bg-slate-800 rounded shadow shadow-slate-50 dark:shadow-slate-700">
          ...
          <ul className="flex itens-center justify-between">
            ...
            <li className="flex items-center text-rose-600 font-bold text-sm">
              <img src={down} alt="" className="w-3 mr-2" /> 12%
            </li>
          </ul>
        </article>
      </section>
